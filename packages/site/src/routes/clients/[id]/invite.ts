...
import { createAuth0User } from '$lib/services/auth0';
import { z } from 'zod';
...
export const post: RequestHandler = async ({ params }) => {
	...
	const url2 = 'https://dev-eehvhdp2.eu.auth0.com/api/v2/users';
	const token =
