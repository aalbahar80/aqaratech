			...
			>
					...
					<div class="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
						<div class="md:grid md:grid-cols-2 md:gap-8">
							<div>
								...
								<ul class="mt-4 space-y-4">
									{#each footerNavigation.solutions as item (item.name)}
										<li>
											<a
												href={item.href}
							...
							<div class="mt-12 md:mt-0">
								...
								<ul class="mt-4 space-y-4">
									{#each footerNavigation.support as item (item.name)}
										<li>
											<a
												href={item.href}
												class="text-base text-gray-500 hover:text-gray-900"
						...
						<div class="md:grid md:grid-cols-2 md:gap-8">
							<div>
								...
								<ul class="mt-4 space-y-4">
									{#each footerNavigation.company as item (item.name)}
										<li>
											<a
												href={item.href}
												class="text-base text-gray-500 hover:text-gray-900"
							...
							<div class="mt-12 md:mt-0">
								...
								<ul class="mt-4 space-y-4">
									{#each footerNavigation.legal as item (item.name)}
										<li>
											<a
												href={item.href}
												class="text-base text-gray-500 hover:text-gray-900"
				...
				<div class="mt-12 border-t border-gray-200 py-8">
					<p class="text-base text-gray-400 xl:text-center">
						&copy; {new Date().getUTCFullYear()} Workflow, Inc. All rights reserved.
					</p>
				</div>
			</div>
		</footer>
