<script lang="ts">
	import { ChevronLeft, Printer } from '@steeze-ui/heroicons';
	...
	<div class="mt-2 md:flex md:items-center md:justify-between">
		<div class="min-w-0 flex-1">
			...
			<p class="max-w-md text-sm text-gray-500">
				This contract has been automatically generated. You may edit the text
				before printing.
			</p>
		</div>
		<div class="mt-4 flex flex-shrink-0 md:mt-0 md:ml-4">
			...
			>
				<Icon src={Printer} class="-ml-1 mr-2 h-5 w-5" aria-hidden="true" />
				Print
			</button>
		</div>
	</div>
