...
const ar: Translation = {
	...
	landing: {
		callToAction: {
			button: 'إنشاء حساب',
			description: 'منصة عقاراتك تمنحك تجربة سهلة ومريحة لإدارة العقارات.',
		...
		features: {
			data: {
				bullets: {
					monitor:
						'بإمكانك مراقبة معدلات إشغال العقارات وفترات الشغور باستخدام التمثيل البياني للخرائط الحرارية.',
					track:
						'بإمكانك إجراء تتبع شامل للبيانات المتعلقة بالعقارات، بما في ذلك الوحدات العقارية وعقود الإيجار والمستأجرين وغيرها الكثير.',
					visualize:
						'بإمكانك إعداد تمثيل بياني حراري للبيانات المالية الخاصة بالعقارات، مما يتيح لك تحديد التوجّهات والأنماط بمرور الوقت. باستخدامك لوحة البيانات التفاعلية، يمكنك معاينة انواع الدخل والمصاريف والأرباح/الخسائر لكل محفظة وعقار ووحدة سكنية.',
				},
			...
			document: {
				bullets: {
					access:
						'بإمكانك الوصول إلى الوثائق الخاصة بك من أي مكان وباستخدام أي جهاز.',
					upload:
						'بإمكانك تخزين الوثائق المهمة المتعلقة بالعقارات وبالمستأجرين، بما فيها عقود الإيجار وإيصالات دفع الإيجار وسجلات الصيانة، ونُتيح لك إدارة تلك الوثائق.',
				},
			...
			expense: {
				bullets: {
					...
					visualize:
						'بإمكانك إعداد تمثيل بياني المصاريف باستخدام مخططات هيكلية تفاعلية، مما يتيح لك معرفة أنماط التكاليف الخاصة بك.',
				},
			...
			filter: {
				bullets: {
					...
					properties:
						'بإمكانك تصنيف العقارات وبيانات المستأجرين حسب الموقع، بما في ذلك ممتلكات أو وحدات معيّنة ضمن العقار.',
			...
			rental: {
				bullets: {
					reminders: 'ميزة إشعارات التذكير للتحصيلات.',
					track: 'سهولة في تتبع تحصيل الإيجار وعقود الإيجار وسهولة إدارتها.',
				},
		...
		hero: {
			description:
				'توفر لك منصة "عقاراتك" وسيلة شاملة وسهلة الاستخدام، تمكنك بإدارة العقارات وتتبع العمليات و الوصول السريع إلى المعلومات المهمة.\n',
			subtitle: 'سهولة إدارة العقارات.',
			titlePrefix: 'منصة عقاراتك.',
			titleSuffix: ' تنظيم إدارة العقارات.',
		},
		location: 'الموقع',
		map: 'الخريطة',
		secondaryFeatures: {
			...
			tenants: {
				description:
					'توفر منصة عقارات سهولة في معاملة الإيجار، مما يتيح للمستأجرين تتبع مدفوعاتهم وعقود الإيجار الخاصة بهم.',
