...
export class FilesApi extends runtime.BaseAPI {
	...
	async findOneRaw(
		...
		if (
			...
			throw new runtime.RequiredError(
				'organizationId',
				'Required parameter requestParameters.organizationId was null or undefined when calling findOne.',
			);
		}
		...
		const response = await this.request(
			{
				path: `/organizations/{organizationId}/files/find-one`.replace(
					`{${'organizationId'}}`,
					encodeURIComponent(String(requestParameters.organizationId)),
				),
				method: 'GET',
