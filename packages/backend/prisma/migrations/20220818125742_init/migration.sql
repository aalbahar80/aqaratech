...
-- CreateIndex
CREATE INDEX "Lease_portfolioId_idx" ON "Lease"("portfolioId");

-- CreateIndex
CREATE INDEX "MaintenanceOrder_organizationId_idx" ON "MaintenanceOrder"("organizationId");
...
-- CreateIndex
CREATE INDEX "LeaseInvoice_organizationId_idx" ON "LeaseInvoice"("organizationId");

-- CreateIndex
CREATE INDEX "LeaseInvoice_portfolioId_idx" ON "LeaseInvoice"("portfolioId");
...
-- CreateIndex
CREATE INDEX "Unit_portfolioId_idx" ON "Unit"("portfolioId");
...
-- AddForeignKey
ALTER TABLE "Lease" ADD CONSTRAINT "Lease_portfolioId_fkey" FOREIGN KEY ("portfolioId") REFERENCES "Portfolio"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MaintenanceOrder" ADD CONSTRAINT "MaintenanceOrder_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LeaseInvoice" ADD CONSTRAINT "LeaseInvoice_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeaseInvoice" ADD CONSTRAINT "LeaseInvoice_portfolioId_fkey" FOREIGN KEY ("portfolioId") REFERENCES "Portfolio"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Unit" ADD CONSTRAINT "Unit_portfolioId_fkey" FOREIGN KEY ("portfolioId") REFERENCES "Portfolio"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
