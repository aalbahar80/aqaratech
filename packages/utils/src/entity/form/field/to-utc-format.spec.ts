...
const valid: [string, unknown][] = [
	...
	['2021-01-01T00:00:00.000Z', 'Jan 1, 2021'],
	['2021-01-01T20:00:00.000Z', 'Jan 1, 2021'],
	['2021-01-01T23:59:59.999Z', 'Jan 1, 2021'],
	['2021-01-02T00:00:00.000Z', 'Jan 2, 2021'],
	['2021-01-02T00:01:00.000Z', 'Jan 2, 2021'],
];

test.each(valid)('toUTCFormat(%s)', (input, expected) => {
